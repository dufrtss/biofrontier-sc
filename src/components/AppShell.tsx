...
export default function AppShell() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Top bar */}
      <header className="relative flex items-center justify-between px-5 py-3 bg-[--surface] border-b border-[--border]/60 shrink-0 z-10">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-80 shrink-0 bg-[--surface] border-r border-[--border]/60 overflow-hidden">
          <FrontierRanking
        ...
        <aside
          className={[
            'shrink-0 bg-[--surface] border-l border-[--border] overflow-hidden transition-all duration-200',
