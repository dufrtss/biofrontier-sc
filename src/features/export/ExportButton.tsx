...
export default function ExportButton({
  ...
  return (
    <div className="relative border-t border-slate-200 shrink-0">
      {open && !disabled && (
        <>
          ...
          />
          <div
            className="absolute bottom-full left-3 right-3 mb-1 z-[1601] rounded-lg overflow-hidden bg-slate-50 border border-slate-200 shadow-xl"
            role="menu"
          >
            <button
              onClick={() => exportCsv('visible')}
              className="w-full text-left px-3 py-2.5 text-xs text-slate-500 hover:bg-slate-100 transition-colors"
              role="menuitem"
              type="button"
            >
            ...
            <button
              ...
              className="w-full text-left px-3 py-2.5 text-xs text-slate-500 hover:bg-slate-100 transition-colors border-t border-slate-200"
              role="menuitem"
              type="button"
            >
